...
import rnu.fst.gestiondedepatement.session.AnneeuniversitaireFacade;
...
public class AnneeuniversitaireController implements Serializable {
    ...
    @EJB
    private rnu.fst.gestiondedepatement.session.AnneeuniversitaireFacade ejbFacade;
    ...
    public Anneeuniversitaire getAnneeuniversitaire(java.lang.Integer id) {
