...
import rnu.fst.gestiondedepatement.session.SpecialiteFacade;
...
public class SpecialiteController implements Serializable {
    ...
    @EJB
    private rnu.fst.gestiondedepatement.session.SpecialiteFacade ejbFacade;
    ...
    public Specialite getSpecialite(java.lang.Integer id) {
