...
import rnu.fst.gestiondedepatement.entity.Section;
...
import rnu.fst.gestiondedepatement.session.SectionFacade;
...
public class SectionController implements Serializable {
    ...
    @EJB
    private rnu.fst.gestiondedepatement.session.SectionFacade ejbFacade;
