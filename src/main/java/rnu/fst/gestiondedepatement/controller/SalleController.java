...
import rnu.fst.gestiondedepatement.entity.Salle;
...
import rnu.fst.gestiondedepatement.session.SalleFacade;
...
public class SalleController implements Serializable {
    ...
    @EJB
    private rnu.fst.gestiondedepatement.session.SalleFacade ejbFacade;
    ...
    public Salle getSalle(java.lang.Integer id) {
    ...
    public static class SalleControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Salle) {
                ...
                return getStringKey(o.getCodesalle());
            } else {
